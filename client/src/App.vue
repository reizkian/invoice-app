<template>
  <div>
    <div v-if="mobile" class="mobile-message flex flex-column">
      <h2>Sorry, this app is not supported for mobile devices</h2>
...
export default {
  ...
  methods: {
    ...mapActions(["READ_INVOICES"]),
    checkScreen() {
      const windowWidth = window.innerWidth;
      windowWidth <= 750 ? (this.mobile = true) : (this.mobile = false);
    },
  },
  computed: {
